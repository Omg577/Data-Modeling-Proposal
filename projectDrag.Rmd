...
In our data set we have many variables that could help us find what helps students. In this analysis we specifically are focusing on the column which includes the number of prior courses they have failed; ranging from 0-3. And their final exam score. Which is scored on a 0-20 scale. 

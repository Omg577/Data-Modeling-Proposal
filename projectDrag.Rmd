...
In the rest of the report, we plan to explore the relationship between prior failures and final math achievement using both graphical and statistical methods. We will begin with [insert exact methods we use here]
